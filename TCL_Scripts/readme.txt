...
* src_stimulus: contains testbench, wave.do and other required simulation files.
...
The TCL scripts are validated for Libero v2022.2 and IP versions as specified in the common.tcl. To run the TCL, follow:
